...
class BLDCDriver3PWM: public BLDCDriver
{
  public:
    ...
    */
    BLDCDriver3PWM(int phA,int phB,int phC, int enA = NOT_SET, int enB = NOT_SET, int enC = NOT_SET);
    ...
    int enable_pinA; //!< enable pin number
    int enable_pinB; //!< enable pin number
    int enable_pinC; //!< enable pin number
